...
Answer the questions provided in `questionnaire.pdf` using **your usual pipeline**, your preferred tools, your usual hyper-parameters, and your usual assumptions.
...
Lastly, while optional, we strongly encourage you to submit also a brief explanation (~2-5 sentences) of how you arrived at your answer 
...
We put an emphasis on reducing to a minimum the complexity of meta-data and data manipulation. 
